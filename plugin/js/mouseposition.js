L.Control.MousePosition = L.Control.extend({
	...
	options: {
		...
		separator: ' : ',
		emptyString: '<b><span style="font-size: 125%; color: #fff">9.077902 : 105.045129</span></b>',
		lngFirst: false,
		numDigits: 5,
	...
	_onMouseMove: function (e) {
		...
		this._container.innerHTML = "<b><span style='font-size: 125%; color: #fff'>" + prefixAndValue + "</span></b>";
	}
